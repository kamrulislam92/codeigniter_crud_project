        ...
        <div class="col-sm-12 col-md-12 p-5">
            ...
            <!-- <form method="post" action="<?php //echo site_url('userController/update'); ?>" class="row gy-2 gx-3 align-items-center bg-dark p-5">
                ...
                <div class="col-6">
                    ...
                    <input type="text" class="form-control" id="autoSizingInputGroup" value="<?php //echo $edit_data['name']; ?>" >
                    </div>
                </div>
                <div class="col-6">
                    ...
                    <input type="text" class="form-control" id="autoSizingInputGroup"value="<?php //echo $edit_data['email']; ?>" >
                    </div>
                </div>

                <div class="d-grid gap-2 col-6 mx-auto">

                <button class="btn btn-primary mt-3" type="button">Submit</button>
                </div>
            </form> -->
            <form method="post" action="<?php echo site_url('userController/update'); ?>" class="row gy-2 gx-3 align-items-center bg-dark p-5">
    <div class="col-12">
